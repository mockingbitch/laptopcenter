        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-service">
                    <i class="ti-tag"></i>
                    <h4>Giá tốt nhất</h4>
                    <p>Ở đâu giá rẻ, chúng tôi rẻ hơn</p>
                </div>
                <!-- End Single Service -->
            </div>
        </div>
            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="left">
                            <p>Copyright © 2021 <a href="#" target="_blank">Hoan Chu</a> - All Rights Reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="right">
