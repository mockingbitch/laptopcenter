                ...
                <?php if (isset($_SESSION['cart'])): ?>
                    ...
                    <table class="table shopping-summery" >
                        ...
                        <?php foreach ($_SESSION['cart'] as $key => $value ) : ?>
                            <tr>
                                <td class="image" data-title="No"><img width="100px" src=" admin/uploads/<?php echo $value['img'] ?>" alt="#"></td>
                                ...
                                <td class="qty" data-title="Qty" align="center"><!-- Input Order -->
                                    <div class="input-group sm">
                                        <input onchange="updateCart(<?php echo $key; ?>)" id="qty_<?php echo $key; ?>" type="number" name="quant" class="input-number sm"  value="<?php echo $value['qty']; ?>">
                                    </div>
                                    <!--/ End Input Order -->
                                </td>
                    ...
                    <div class="row total">
                        ...
                        <div class="col-lg-4 col-md-7 col-12">
                            <div class="right">
                                ...
                                <div class="button5">
                                    <a href="thanhtoan.php" class="btn"><h4>Thanh toán</h4></a>
...
<script>
    function updateCart(id){
        ...
        $.post('updatecart.php',{'id':id,'num':num},function(data){
            $("#listcart").load("http://localhost/laptopcenter/viewcart.php .cart");
            $("#listproduct").load("http://localhost/laptopcenter/viewcart.php .cartreload");
            $(".total-amount").load("http://localhost/laptopcenter/viewcart.php .total");
        });
    }
