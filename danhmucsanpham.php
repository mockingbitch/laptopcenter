...
?>
<?php
if(!isset($_GET['thuonghieu']) || $_GET['thuonghieu'] == NULL) {
        ...
        <div class="row">
            ...
            <div id="store" class="col-md-9">
                ...
                <div class="row">
                    ...
                    $product = new sanpham();
                    $show_product = $product->show_sanphamtheoid($id);
                    if ($show_product){
                            ...
                            <div class="col-md-4 col-xs-6">
                                ...
                                <div class="single-product" style="border: 1px solid grey">
                                    <div class="product-img" >
                                        <a href="chitietsanpham.php?id=<?= $result['idsanpham']; ?>">
                                            <img class="default-img" src="admin/uploads/<?= $result['hinhanh']; ?>" alt="#">
                                            <img class="hover-img" src="admin/uploads/<?= $result['hinhanh']; ?>" alt="#">
                                        ...
                                        <div class="button-head">
                                            ...
                                            <div class="product-action-2">
                                                <a title="Add to cart" onclick="addCart(<?php echo $result['idsanpham'] ?>)">Thêm vào giỏ hàng</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-content">
                                        <h3 align="center"><a href="chitietsanpham.php?id=<?= $result['idsanpham'] ?>"><?= $result['tensanpham']; ?></a></h3>
                                        <div class="product-price" align="right">
                                            <span>Giá: </span>
<!--                                            <span class="old">--><?php //echo number_format($result['productPrice'],0,',','.');?><!--</span>-->
                                            <span style="color: red; font-weight: bold;font-size: 18px"><?php echo number_format($result['gia'],0,',','.');?> VND</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
