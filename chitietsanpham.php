...
<div class="section" style="margin: 100px">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            $sanpham = new sanpham();
            $show_chitiet = $sanpham->show_chitietsanpham($id);
            if ($show_chitiet){
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <div class="add-to-cart">
                        ...
                        <button style="margin: 30px 0px 0px 170px" class="add-to-cart-btn"><a href="giohang.php" style="color: white;font-weight: bold"><i class="fa fa-shopping-cart"></i> Xem giỏ hàng</a></button>
                    </div>
