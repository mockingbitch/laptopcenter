...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
            ...
            <div class="sidebar-brand-text mx-3">LaptopCenter</div>
        </a>
...
<!--                    <h6 class="collapse-header">Bootstrap UI</h6>-->
                    <a class="collapse-item" href="themdanhmuc.php">Thêm danh mục</a>
                    <a class="collapse-item" href="danhsachdanhmuc.php">Danh sách danh mục</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="danhsachsanpham.php">Danh sách sản phẩm</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="images/man.png" style="max-width: 60px" alt="">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="dropdown-list-image mr-3">
                                    <img class="rounded-circle" src="images/girl.png" style="max-width: 60px" alt="">
